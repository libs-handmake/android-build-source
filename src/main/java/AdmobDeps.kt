...
object AdmobDepsVer {
    const val APPLOVIN_VERS = "12.6.0.0"
    const val MINTEGRAL_VERS = "16.8.11.0"
    const val IRON_SOURCE_VERS = "7.7.0.0"
    const val PANGLE_VERS = "6.1.0.7.0"
    const val META_VERS = "6.16.0.0"
    const val UMP_VER = "3.0.0"
