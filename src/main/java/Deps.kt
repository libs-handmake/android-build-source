object Deps {
    ...
    const val ACTIVITY = "androidx.activity:activity:${DepVers.ACTIVITY_VERSION}"
    const val ACTIVITY_KTX = "androidx.activity:activity-ktx:${DepVers.ACTIVITY_VERSION}"
...
object DepVers {
    const val KTX_CORE_VER = "1.13.1"
    const val APPCOMPAT_VER = "1.7.0"
    const val MATERIAL_VER = "1.11.0"
    const val CONSTRAINT_LAYOUT_VER = "2.1.4"
    const val JUNIT_TEST_VER = "4.13.2"
    const val JUNIT_TEST_EXT_VER = "1.2.1"
    const val EPRESSO_CORE = "3.6.1"
    const val GSON_VER = "2.11.0"
    const val EVENTBUS_VER = "3.3.1"
    const val SDP_VER = "1.1.1"
    const val SDP_COMPOSE_VER = "1.1.0"
    const val LIFECYCLE_VER = "2.8.4"
    const val GLIDE_VER = "4.16.0"
    const val LOTTIE_VER = "6.5.0"
    ...
    const val ACTIVITY_VERSION = "1.9.1"
    const val FRAGMENT_VERSION = "1.8.2"
    ...
    const val FIREBASE_BOM_VER = "33.1.2"
    const val ADMOB_VER = "23.3.0"
    ...
    const val CONSTRAINT_LAYOUT_COMPOSE_VER = "1.0.1"
    const val SHIMMER_COMPOSE = "1.3.0"
